namespace FormProyecto
{
    partial class DetalleVentas
    {
        ...
        private void InitializeComponent()
        {
            ...
            label14.Location = new Point(46, 18);
            label14.Name = "label14";
            label14.Size = new Size(201, 60);
            label14.TabIndex = 154;
            label14.Text = "DATOS DE DETALLES DE VENTAS";
            ...
            txtBuscar.Location = new Point(154, 71);
            ...
            lblTitulo.Location = new Point(372, 21);
            lblTitulo.Name = "lblTitulo";
            lblTitulo.Size = new Size(208, 28);
            lblTitulo.TabIndex = 163;
            lblTitulo.Text = "DETALLES DE VENTAS";
            // 
            // dgvDetalleVentas
            // 
            dgvDetalleVentas.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            dgvDetalleVentas.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dgvDetalleVentas.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells;
            dgvDetalleVentas.BackgroundColor = Color.WhiteSmoke;
            dgvDetalleVentas.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgvDetalleVentas.Location = new Point(29, 120);
            dgvDetalleVentas.MultiSelect = false;
            dgvDetalleVentas.Name = "dgvDetalleVentas";
            dgvDetalleVentas.RowHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
            dgvDetalleVentas.RowTemplate.Height = 25;
            dgvDetalleVentas.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgvDetalleVentas.Size = new Size(918, 607);
            dgvDetalleVentas.TabIndex = 162;
            // 
            // erpError
            // 
